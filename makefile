...
FINITE_SOURCES = src/main_finite_size.cpp
...
SUSCEP_SOURCES = src/main_suscept.cpp
SUSCEP_EXEC = bin/suscept.o
...
$(SUSCEP_EXEC): $(SUSCEP_SOURCES)
	g++ -o $(SUSCEP_EXEC) $(SUSCEP_SOURCES) $(LIBS) -O3;
	$(SUSCEP_EXEC)
